...
public class ReadPaycardConstsHelper {
    ...
    public static final byte[] ADDTIONAL_TERMINAL_CAPABILITIES_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x40
    };

    public static final byte[] ADDTIONAL_TERMINAL_CAPABILITIES_EXTENSION_TLV_TAG = {
            (byte) 0xDF,
            (byte) 0x3A
    };


    public static final byte[] TERMINAL_CAPABILITIES_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x33
    };


    public static  final byte[] TERMINAL_APPLICATION_VERSION_NUMBER_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x09
    };

    public static  final byte[] MERCHANT_CATEGORY_CODE_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x15
    };

    public static final byte[] SERVICE_ID_TLV_TAG = {
            (byte) 0xDF,
            (byte) 0x16
    };
    // - TLV Tag(s) (Constant(s))
