...
public class PaycardObject {
    ...
    private byte[] mCAflRecordsList = null, mRAflRecordsList = null;
    ...
    private byte[] mCLogEntryList = null, mRLogEntryList = null;
    ...
    public byte[] getCAflRecordsList() {
        return mCAflRecordsList;
    }
    public void setCAflRecordsList(byte[] cAflRecordsList) {
        this.mCAflRecordsList = cAflRecordsList;
    }
    public byte[] getRAflRecordsList() {
        return mRAflRecordsList;
    }
    public void setRAflRecordsList(byte[] rAflRecordsList) {
    ...
    public byte[] getCLogEntryList() {
        return mCLogEntryList;
    }
    public void setCLogEntryList(byte[] cLogEntryList) {
        this.mCLogEntryList = cLogEntryList;
    }

    public byte[] getRLogEntryList() {
        return mRLogEntryList;
    }
    public void setRLogEntryList(byte[] rLogEntryList) {
